...
class BacktestingEngine(object):
    ...
    settingFileName = '/Users/xuegeng/Desktop/Algo/' + settingFileName
    contractSettingFileName = '/Users/xuegeng/Desktop/Algo/' + contractSettingFileName
...
#        initTimeDelta = timedelta(initDays)
    ...
    def loadStrategy(self, setting):
        ...
        try:
            ...
            self.output(YELLOWPREFIX + u"载入策略： " + name)
        except Exception, e:
